   ...
   BeginProperty Section1 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item13 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Total Item/s Rented"
      EndProperty
      ItemType14      =   3
      ...
      BeginProperty Item17 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "_  _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _  _ "
      EndProperty
      ItemType18      =   3
      ...
      BeginProperty Item25 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "This will serve as your Official Receipt"
         Alignment       =   2
      EndProperty
      ItemType26      =   3
...
Private Sub DataReport_Initialize()
  With Me.Sections("Section2").Controls
    .Item("Label10").Caption = frmRent.lblMemName.Caption
    .Item("Label12").Caption = frmRent.txt5.Text
    .Item("Label13").Caption = frmRent.txtAmount.Text
    .Item("Label16").Caption = frmRent.txtItemCount.Text
    .Item("lblCashAmount").Caption = frmCashier.txtCash.Text
    .Item("lblChangeAmount").Caption = frmCashier.txtChange.Text
      If frmRent.txtItemCount.Text = 1 Then
        .Item("lblOR").Caption = "TRANS# " & frmRent.txtrrtransno.Text
      ElseIf frmRent.txtItemCount.Text = 2 Then
        .Item("lblOR").Caption = "TRANS# " & frmRent.Text6.Text & "-" & Right(frmRent.Text7.Text, 2)
      ElseIf frmRent.txtItemCount.Text = 3 Then
        .Item("lblOR").Caption = "TRANS# " & frmRent.Text6.Text & "-" & Right(frmRent.Text8.Text, 2)
      ElseIf frmRent.txtItemCount.Text = 4 Then
        .Item("lblOR").Caption = "TRANS# " & frmRent.Text6.Text & "-" & Right(frmRent.Text9.Text, 2)
      ElseIf frmRent.txtItemCount.Text = 5 Then
        .Item("lblOR").Caption = "TRANS# " & frmRent.Text6.Text & "-" & Right(frmRent.Text10.Text, 2)
      End If
  End With
End Sub
